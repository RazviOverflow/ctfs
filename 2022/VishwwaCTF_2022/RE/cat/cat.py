...
def rev_multiply_by_len_div_3_ret_string(passed_string):
    return str(int(passed_string)//user_input_len_divided_by_3)
...
def rev_process(passed_string):
    index1 = 9
    index2 = 7
    auxiliar = 0
    result_string = list(passed_string)
    while index1 > 0 and index2 > 0:
        if auxiliar%3 == 2//4:
            ...
            result_string += passed_string[index1]
            index1 -= 1
            print(passed_string[index1], end="")
        auxiliar += 1
    return result_string
...
def rev_caT(passed_string):
    return rev_multiply_by_len_div_3_ret_string(passed_string[:user_input_len_divided_by_3]) - passed_string[::-1]
...
#"Cat9024"
user_input = "C20a73t0294t0ac2194"
